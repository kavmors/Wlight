...
include_once dirname(__FILE__). '/SHA1.class.php';
include_once dirname(__FILE__). '/Prpcrypt.class.php';
include_once dirname(__FILE__). '/PKCS7Encoder.class.php';
include_once dirname(__FILE__). '/ErrorCode.class.php';
