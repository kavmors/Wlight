 ...
 *
 * array getMenu()
 * array addSubButton(string, array)
 * array addClick(string, string)
 * array addView(string, string)
 * array addScan(string, string, string)
 * array addPic(string, string, string)
 * array addLocation(string, string)
 */
...
class MenuDesigner {
   ...
   * @return array 菜单生成数组
   */
  public function addScan($name, $key, $type=self::PUSH) {
    $button = array(
      'type' => $type,
      'name' => $name,
      'key' => $key
   ...
   * @return array 菜单生成数组
   */
  public function addPic($name, $key, $type=self::PHOTO_OR_ALBUM) {
    $button = array(
      'type' => $type,
      'name' => $name,
      'key' => $key
